...
void EvseManager::ready() {
    ...
    if (config.ac_with_soc) {
        ...
        charger->setup(get_charger_setup_config(charge_mode, false, hlc_enabled));
    }
...
void EvseManager::setup_fake_DC_mode() {
    ...
    charger->setup(get_charger_setup_config(Charger::ChargeMode::DC, false, hlc_enabled));
...
void EvseManager::setup_AC_mode(bool ac_hlc_enabled) {
    ...
    charger->setup(get_charger_setup_config(Charger::ChargeMode::AC, true, ac_hlc_enabled));
